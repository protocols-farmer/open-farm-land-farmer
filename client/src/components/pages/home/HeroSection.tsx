  ...
  return (
    <section className="relative w-full pt-16 pb-12 overflow-hidden">
      ...
      <div className="container mx-auto px-4">
        {/* Changed to CSS Grid: exactly 50% width each, and stretched to equal height */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-stretch">
          ...
          <div className="flex flex-col justify-between w-full h-full space-y-4 relative">
            <div>
              ...
              <Link
                href={
                  versionData?.id ? `/updates/${versionData.id}` : "/updates"
                }
              ...
              <p className="text-muted-foreground leading-relaxed">
                This is a platform for sharing your ideas, project journey,
                blogs, resources, articles and more, you name it!
              </p>
            </div>
